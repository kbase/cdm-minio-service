    ...
    async def put_object(self, bucket_name: str, key: str, body: bytes) -> bool:
        ...
        try:
            async with self._get_client() as client:
                ...
                logger.debug(f"Put object {key} in bucket {bucket_name}")
                return True
        except Exception as e:
    ...
    async def get_object(self, bucket_name: str, key: str) -> bytes:
        ...
        try:
            async with self._get_client() as client:
                ...
                logger.debug(f"Got object {key} from bucket {bucket_name}")
                return body
        except Exception as e:
    ...
    async def delete_object(self, bucket_name: str, key: str) -> bool:
        ...
        try:
            async with self._get_client() as client:
                ...
                logger.debug(f"Deleted object {key} from bucket {bucket_name}")
                return True
        except Exception as e:
            logger.error(
